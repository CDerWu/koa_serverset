...
process.env.NODE_ENV = 'production'; //after config.js
...
module.exports = {
    ...
    output: {
        ...
        filename: '[name].js',
        publicPath: '/public/static/build/'
    },
    ...
    */
    ...
    plugins: [
        ...
        new webpack.DllReferencePlugin({
            context: path.join(__dirname, "public", "dll", "production"),
            manifest: require("./public/dll/production/vendor-manifest.json")
        }),
        new HappyPack({
            id: 'babel',
